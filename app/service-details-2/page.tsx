              ...
              <div className="row clearfix">
                  ...
                  <div className="service-sidebar mr_30">
                    <div className="category-widget">
                      ...
                      <ul className="category-list clearfix">
                        ...
                        <li><Link href="/service-details-2" className="current"><span>Content Marketing</span> <i className="icon-1"></i></Link></li>
                ...
                <div className="col-lg-6 col-md-12 col-sm-12 content-side">
                  <div className="service-details-content">
                    <h2 className="mb_16">Content Marketing for Business Growth</h2>
                    <p className="mb_40">Content marketing is essential for building brand awareness, engaging your audience, and driving conversions. A strong content strategy can increase your visibility, establish trust, and boost long-term growth.</p>

                    <h3 className="mb_16">Content Strategy</h3>
                    <p className="mb_40">We develop tailored content strategies that align with your business goals and audience interests. This includes blog posts, articles, social media content, and more.</p>

                    <h3 className="mb_16">SEO & Keyword Optimization</h3>
                    <p className="mb_20">Effective SEO ensures your content reaches the right audience. We identify high-value keywords and optimize content to improve search engine rankings.</p>

                    <figure className="image mb_40">
                      <Image src="/assets/images/service/service-3.jpg" alt="Content Marketing" width={630} height={351} priority />
                    </figure>

                    <h3 className="mb_16">Content Distribution</h3>
                    <p>We implement multichannel content distribution to maximize reach and engagement. This includes social media, email marketing, and influencer partnerships.</p>
                  </div>
                </div>
